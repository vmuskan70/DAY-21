...
function Score() {
  ...
  <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-700 to-pink-500'>
    ...
    <h2 className='text-2x1 font-bold text-gray-700 mb-2'>
Cricket Score
  </h2>
...
<button className='bg-blue-600 px-8 py-3 text-white text-lg font-semibold rounded-xl hover:bg-blue-700 active:scale-95 transition-all duration-200 shadow-[0_0_10px_rgba(0,0,0,1)]'onClick={()=>{
    setScore(score+1);
}}>
    increament</button>
  </div>
